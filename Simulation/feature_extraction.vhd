...
begin
    if reset = '1' then
        ...
        if valid_in = '1' and binary_pixel = '1' then
...
-- ==========================================================
-- Python-equivalent normalized features
-- ==========================================================
 
-- f0 = total foreground density
...
-- f4 = bottom-half density
f4 <= (bottom_count * 255) / 2048;
 
-- f5 = left-half density
f5 <= (left_count * 255) / 2048;
 
-- f6 = right-half density
f6 <= (right_count * 255) / 2048;
 
-- f7 = center 16x16 density
f7 <= (center_count * 255) / 256;
 
-- 4x4 grid normalized densities
-- each region is 16x16 = 256 pixels
r0  <= (sr0  * 255) / 256;
r1  <= (sr1  * 255) / 256;
r2  <= (sr2  * 255) / 256;
r3  <= (sr3  * 255) / 256;
